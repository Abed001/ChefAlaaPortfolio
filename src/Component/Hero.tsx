import newhero from "../assets/newhero.webp";
  ...
  return (
    ...
    >
      <div className="px-4 sm:block text-left flex flex-col justify-center w-[100%]  ">
        <div className=" lg:ml-40 lg:mt-[-50px] lg:block text-left flex flex-col justify-center lg:w-[500px] ">
          {" "}
      ...
      <img
        src={newhero}
        className=" lg:mr-40 mb-10 rounded-4xl lg:w-[500px] lg:mt-10 w-full object-cover object-center"
      />
    </div>
  );
}
